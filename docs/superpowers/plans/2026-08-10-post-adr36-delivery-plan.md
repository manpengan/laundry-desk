...
> 日期：2026-08-10
> 状态：**阶段 1、2 已关闭；阶段 3.1「价目治理」本地已验证，GitHub/云端关闭进行中**
...
|    3 | **进行中** | 经营增强：价目排序/重新启用/审计、Owner 公网经营与门店管理、会员等级/积分/次卡/券/有效期、顾客扩展档案               | 3.1 已按 ADR-39 本地验证；待 PR/主线 CI、0048 精确发布与公网验收后关闭该切片         |
...
1. **进行中：**价目排序、停用项重新启用与管理员审计入口；ADR-39、本地真实 PG、
   Chromium 17/17 与 workspace 总门禁已通过，待 GitHub 和 hk-vps 关闭；
