...
| A2 | [统一信封 + 错误码表](a2-envelope-and-errors.md) | **✅ 已冻结**（[冻结结论](2026-07-20-a2-freeze-verdict.md)：0 必修 / 1 记录；§2.1–§2.6 全部以机制实现）。下游 Gemini C7 的两前置已到其一，仍等 A6 |
...
**注**：Grok 的 **D1 Electron 壳**与 **D5 A/B 双槽**、Gemini 的 **F2 种子数据**经复核**不依赖任何契约组**，已于 2026-07-20 单独解闸（见 [解闸提示词](2026-07-20-unblock-prompts.md)）——开工提示词此前将其误列在闸后。解闸后 Grok 的 D1/D5 已合入（PR #45/#46），Gemini 的四项完成但**未开 PR**（见 [交付提示词](2026-07-20-gemini-delivery-prompt.md)）。
