...
> 范围：本文件保留 M0 验证与 M1 基座的历史任务/证据；未完成工作已由 ADR-12、ADR-13 与 V2-only 执行计划接管。M2–M6 的范围见 ADR-07。
> 当前路线：Grok 为单一技术负责人；v2 是唯一活动交付线。下文旧四线/ADR-10 分工和时间线只保留历史事实，不承担当前调度职责。
...
## 5. 历史下一步（2026-07-21，已由 ADR-12 / ADR-13 取代）
