...
| 当前阶段   | **阶段 1 待合入**：macOS 当前 Web 产品面已新鲜通过 `local:acceptance`（Browser 17/17、打包 Counter 7/7）和全新 macOS 投产验收（1/1）；Runtime.app 托管真实 Server OCI 与打包 Counter 的回环组合、工作区总门禁也已通过。阶段 1 仍须完成 PR 合入与 `main` required CI 后才关闭                                                                                                                                                     |
| 设计真源   | [本地优先产品设计](docs/superpowers/specs/2026-07-25-local-first-v2-product-design.md) · [ADR-16](docs/adr/2026-07-31-adr-16-edge-operations-scope-ratification.md) · [ADR-36](docs/adr/2026-08-09-adr-36-cloud-test-environment.md) · [后续 1–6 交付计划](docs/superpowers/plans/2026-08-10-post-adr36-delivery-plan.md) · [macOS Web 产品面对齐验收](docs/superpowers/specs/2026-08-10-macos-web-product-parity-acceptance.md) |
| 当前 owner | **Codex** — 设计、实现、集成与门禁                                                                                                                                                                                                                                                                                                                                                                                               |
| 目标平台   | 当前：macOS Counter/Runtime 软件组合；随后依次为 XP-58 真机、macOS 正式发布、Windows 真实主机、生产 SaaS、多门店/运维及 AI/迁移                                                                                                                                                                                                                                                                                                  |
