...
/** Tables deferred past M1 identity/platform + M2 order/catalog/payments skeleton (edge / AI). */
export const DEFERRED_V2_TABLES_NOTE = Object.freeze({
  reason:
    "packages/db ships identity/platform + A5 session + M2 order/catalog/payments skeleton; remaining A3 matrix tables land with later domain packages.",
