...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f src/migrations/0016_order_hold_lifecycle.sql
```
...
- **M2 order hold lifecycle** (0016): required hold reason marker while the frozen order status remains `open`
