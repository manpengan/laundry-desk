...
export const DEFAULT_BUS_QUERY_DEFINITIONS: readonly AnyDefinition[] = Object.freeze([
  ...
  ...(PRICING_QUERIES as readonly AnyDefinition[]),
  ...(DELIVERY_POLICY_QUERIES as readonly AnyDefinition[]),
  ...(DELIVERY_APPOINTMENT_QUERIES as readonly AnyDefinition[]),
  ...(DELIVERY_EVIDENCE_QUERIES as readonly AnyDefinition[]),
  ...(DELIVERY_ORDER_QUERIES as readonly AnyDefinition[]),
  ...(DELIVERY_TASK_QUERIES as readonly AnyDefinition[]),
  ...(PAYMENT_QUERIES as readonly AnyDefinition[]),
