...
export function buildGp3120StickerCompact(order: SampleOrder): Buffer {
  ...
  return concat(
    ...
    text(16, 32, "TSS16.BF2", `${v.服务} ${v.单价}`, 1, 1, 0, 28),
    text(16, 52, "TSS16.BF2", `${v.挂点} ${v.加急}`, 1, 1, 0, 28),
    text(16, 72, "TSS16.BF2", `${v.姓名} ${v.电话}`, 1, 1, 0, 28),
    text(16, 92, "TSS16.BF2", `${v.票单号} ${v.收件日期}`, 1, 1, 0, 28),
    text(16, 112, "TSS16.BF2", `${v.已消毒} 打开:${v.打开存放}`, 1, 1, 0, 28),
