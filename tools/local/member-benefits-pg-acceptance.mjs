...
const required = (name) => {
  ...
  if (value === undefined || value.length === 0) {
    throw new Error("MEMBER_BENEFITS_PG_INPUT_REQUIRED");
  }
  return value;
};
...
if (
  ...
  throw new Error("MEMBER_BENEFITS_PG_ISOLATION_REQUIRED");
}
...
const exitCode = await new Promise((resolve, reject) => {
  const child = spawn(
    ...
    [
      "--test",
      "--test-concurrency=1",
      "apps/server/dist/member-benefits/pg-member-benefits.test.js",
    ],
    {
      cwd: process.cwd(),
      env: environment,
...
if (exitCode !== 0) throw new Error("MEMBER_BENEFITS_PG_ACCEPTANCE_FAILED");
process.stdout.write("ADR41_MEMBER_BENEFITS_PG_ACCEPTANCE_OK\n");
