...
if (
  ...
  throw new Error("DELIVERY_POLICY_PG_ISOLATION_REQUIRED");
}
...
const exitCode = await new Promise((resolve, reject) => {
  const child = spawn(
    process.execPath,
    ["--test", "--test-concurrency=1", "apps/server/dist/delivery-policy/pg-invariants.test.js"],
...
if (exitCode !== 0) throw new Error("DELIVERY_POLICY_PG_ACCEPTANCE_FAILED");
process.stdout.write("ADR46_DELIVERY_POLICY_PG_ACCEPTANCE_OK\n");
