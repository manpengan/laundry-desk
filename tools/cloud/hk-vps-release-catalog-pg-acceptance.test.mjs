...
const FROM_HEAD = "0046_print_job_request_idempotency.sql";
const TO_HEAD = "0047_cloud_counter_trust.sql";
...
test("queries stable catalog and proves the isolated 0046 to 0047 migration chain", async () => {
  const calls = [];
