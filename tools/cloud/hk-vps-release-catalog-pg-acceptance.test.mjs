...
const FROM_HEAD = "0047_cloud_counter_trust.sql";
const TO_HEAD = "0048_catalog_governance.sql";
...
test("queries stable catalog and proves the isolated 0047 to 0048 migration chain", async () => {
  const calls = [];
